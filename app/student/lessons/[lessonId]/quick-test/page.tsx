...
import ExerciseOverviewPanel from "@/components/student/exercises/ExerciseOverviewPanel";
    ...
    <>
      <div className="space-y-6">
        <ExerciseOverviewPanel
          ...
          totalQuestions={questions.length}
          levelLabel={buMeta.label}
          practiceHref={`/student/lessons/${lessonId}/practice`}
          quickTestHref={`/student/lessons/${lessonId}/quick-test`}
        />
